...
1. **Total Revenue Scorecard:** Overall summary aggregate.
2. **Category Performance:** Revenue breakdown across Furniture, Office Supplies, and Technology.
3. **Sub-Category / Department Breakdown:** Granular sub-category revenue performance.
4. **Yearly Sales Trend:** Historical revenue trajectory from 2012 to 2015.

### 3. Interactive Dashboard Design & Formatting
